    ...
    return {
      ...
      cities: [
        ...
        },
        {
          ...
          description: '青岛是著名的滨海旅游城市，以红瓦绿树、碧海蓝天闻名。这里有栈桥、八大关、崂山等著名景点，是休闲度假的理想之地。'
        },
        {
          name: '烟台',
          image: '/images/yantai.jpg',
          description: '烟台是一座美丽的滨海城市，拥有优美的海岸线和丰富的自然资源。这里有蓬莱阁、养马岛、长岛等著名景点，是集观光、休闲、度假为一体的旅游胜地。'
        },
        {
          name: '威海',
